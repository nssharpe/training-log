...
export const STRENGTH = {
  splits: [
    ...
    },
    {
      ...
      name: "Tue / Thu — PM",
      exercises: [
        ex("A1", "Supine Maltese Dumbbell Flies", "6–8", "4010"),
        ex("A2", "Prone Front Lever Flies", "8–10", "3010"),
        ex("A3", "Prone Reverse Flies", "8–10", "3010"),
        ex("A4", "Prone Front Raises", "8–10", "2010"),
        ex("A5", "Standing Inverted Cross Raises", "6–8", "4010"),
        ex("A6", "Wrist Curls", "8–10", "3010"),
        ex("A7", "Reverse Wrist Curls", "8–10", "3010"),
        ex("A8", "Resisted Pronation / Supination", "10", "2020"),
        ex("A9", "Rice Bucket Exercises", "—", "—"),
